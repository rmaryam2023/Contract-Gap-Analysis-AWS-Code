...
def lambda_handler(event, context): 
   ...
   Triggered by PDF upload to compliance-rules-mr-2026 bucket. 

   Extracts text using Textract ASYNC API (for multi-page PDFs) 

   Saves to processed-output-mr-2026/regulations/ 
   ...
   print(f"Processing regulation document: {key} from bucket: {bucket}") 
   ...
   try: 
       ...
       output_key = f"regulations/{base_name}_regulation_text.json" 
